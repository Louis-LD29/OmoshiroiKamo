...
/**
 * This event is posted to the FML bus when the /reloadConfigs command is run, and should be used to reload your config
 * file and parse its contents.
 * <p>
 * This differs from the existing events because you should call config.load() before re-parsing the contents, to reload
 * the file from disk.
 * <p>
