...
public abstract class ItemBlockBauble extends ItemBlockOK implements IBauble, IAccessory {
    ...
    public ItemBlockBauble(Block block, boolean disableRightClickEquip) {
        super(block);
    ...
    public ItemBlockBauble(Block block1, Block block2, boolean disableRightClickEquip) {
        super(block1, block2);
        this.disableRightClickEquip = disableRightClickEquip;
        setMaxStackSize(1);
    }

    public ItemBlockBauble(Block block1, Block block2) {
