package louis.omoshiroikamo.common.block.test;
...
public class BlockTest extends AbstractMachineBlock<TileTest> implements IAdvancedTooltipProvider, IWandHUD, IWandable {
    ...
    @Override
    protected void init() {
        GameRegistry.registerBlock(this, BlockItemTest.class, modObject.unlocalisedName);
    ...
    public void renderHUD(Minecraft mc, ScaledResolution res, World world, int x, int y, int z) {
        ((TileTest) world.getTileEntity(x, y, z)).renderHUD(mc, res);
    }
