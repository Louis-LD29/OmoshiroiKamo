package louis.omoshiroikamo.common.block.basicblock.solar;
...
public class ItemBlockSolarPanel extends ItemBlockWithMetadata implements IAdvancedTooltipProvider {

    public ItemBlockSolarPanel() {
