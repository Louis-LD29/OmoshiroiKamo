...
public class IESaveData extends WorldSavedData {
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        for (int i = 0; i < receivedShaderList.tagCount(); i++) {
            ...
            ShaderRegistry.receivedShaders.get(player)
                .clear();
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        ...
        for (Map.Entry<DimensionChunkCoords, ExcavatorHandler.MineralWorldInfo> e : ExcavatorHandler.mineralCache
            .entrySet()) if (e.getKey() != null && e.getValue() != null) {
