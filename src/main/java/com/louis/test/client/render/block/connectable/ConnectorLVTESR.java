...
import com.louis.test.common.block.energyConnector.TEConnectorLV;
import com.louis.test.common.core.lib.LibResources;

import blusunrize.immersiveengineering.common.util.chickenbones.Matrix4;

public class ConnectorLVTESR extends AbstractMTESR {

    ModelIEObj modelConnectorLV = new ModelIEObj(LibResources.PREFIX_MODEL + "connectorLV.obj") {

        @Override
        public IIcon getBlockIcon(String groupName) {
            return ModBlocks.blockConnectable.getIcon(0, BlockConnectable.META_connectorLV);
        }
    };
    ...
    public void renderStatic(TileEntity tile, Tessellator tes, Matrix4 translationMatrix, Matrix4 rotationMatrix) {
        if (!(tile instanceof TEConnectorLV te)) return;
        ...
        modelConnectorLV.render(tile, tes, translationMatrix, rotationMatrix, 1, false);
    }
