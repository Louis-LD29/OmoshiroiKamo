...
import com.louis.test.common.block.energyConnector.TEConnectorIV;
import com.louis.test.common.core.lib.LibResources;

import blusunrize.immersiveengineering.common.util.chickenbones.Matrix4;

public class ConnectorIVTESR extends AbstractMTESR {

    ModelIEObj modelConnectorIV = new ModelIEObj(LibResources.PREFIX_MODEL + "connectorIV.obj") {

        @Override
        public IIcon getBlockIcon(String groupName) {
            return ModBlocks.blockConnectable.getIcon(0, BlockConnectable.META_connectorIV);
        }
    };
    ...
    public void renderStatic(TileEntity tile, Tessellator tes, Matrix4 translationMatrix, Matrix4 rotationMatrix) {
        if (!(tile instanceof TEConnectorIV te)) return;
        ...
        modelConnectorIV.render(tile, tes, translationMatrix, rotationMatrix, 1, false);
    }
