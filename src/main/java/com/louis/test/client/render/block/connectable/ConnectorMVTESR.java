...
import com.louis.test.common.block.energyConnector.TEConnectorMV;
...
public class ConnectorMVTESR extends AbstractMTESR {
    ...
    public void renderStatic(TileEntity tile, Tessellator tes, Matrix4 translationMatrix, Matrix4 rotationMatrix) {
        if (!(tile instanceof TEConnectorMV te)) return;
        ...
        modelConnectorMV.render(tile, tes, translationMatrix, rotationMatrix, 1, false);
    }
