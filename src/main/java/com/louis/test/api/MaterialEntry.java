...
public class MaterialEntry {
    ...
    public MaterialEntry(String name, double density, double specificHeat, double thermalConductivity,
    ...
    public MaterialEntry(String name, MaterialConfig config) {
        this.name = name;
        this.defaults = config;
    }

    public MaterialConfig getConfig() {
        return Config.materialConfigs.getOrDefault(name, defaults);
    }
