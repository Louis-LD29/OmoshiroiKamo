package com.louis.test.common.nei.recipe;
...
import com.louis.test.common.block.electrolyzer.TileElectrolyzer;
import com.louis.test.common.nei.PositionedFluidTank;
import com.louis.test.common.nei.RecipeHandlerBase;
...
public class ElectrolyzerRecipeHandler extends RecipeHandlerBase {
    ...
    public void drawExtras(int recipeIndex) {
        ...
        GuiDraw.drawString(
            "Pressure: " + (recipe.getRequiredPressure() != 0 ? recipe.getRequiredPressure() + " atm" : "Not Required"),
            textX,
            textY + lineHeight * line++,
            0x000000,
            false);
