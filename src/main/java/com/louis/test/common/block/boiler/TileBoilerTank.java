...
public class TileBoilerTank extends AbstractMachineEntity implements IFluidHandler, IBoilerNetwork {
    ...
    public String getMachineName() {
        return ModObject.blockBoilerTank.unlocalisedName;
    }
    ...
    public FluidTankInfo[] getTankInfo(ForgeDirection from) {
        return new FluidTankInfo[] { network.getInputTank()
            .getInfo() };
    }
