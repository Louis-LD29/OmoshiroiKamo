...
public class BlockItemFluidFilter extends ItemBlockWithMetadata implements IAdvancedTooltipProvider {

    public BlockItemFluidFilter() {
        super(ModBlocks.blockFluidFilter, ModBlocks.blockFluidFilter);
        setHasSubtypes(true);
        setCreativeTab(TestCreativeTab.INSTANCE);
    }

    public BlockItemFluidFilter(Block block) {
        super(block, block);
        setHasSubtypes(true);
