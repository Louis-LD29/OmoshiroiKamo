...
public class RecipeHandler {
    ...
    public static int loadRecipes(String name) {
        ...
        if (!file.exists()) {
            String resourcePath = "/assets/" + LibMisc.MOD_ID + "/recipes/" + name;
            try (InputStream in = RecipeHandler.class.getResourceAsStream(resourcePath)) {
                if (in != null) {
    ...
    public static int loadRecipesFromFile(File file) {
        ...
        try (FileReader reader = new FileReader(file)) {
            ...
            for (JsonRecipe r : recipes) {
                ...
                if (r == null || r.machine == null || (r.enabled != null && !r.enabled)) {
                    continue;
                }
