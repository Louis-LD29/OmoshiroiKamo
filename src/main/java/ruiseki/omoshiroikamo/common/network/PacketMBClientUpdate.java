...
public class PacketMBClientUpdate extends MessageTileEntity<AbstractMultiBlockModifierTE>
    implements IMessage, IMessageHandler<PacketMBClientUpdate, IMessage> {
