...
import static ruiseki.omoshiroikamo.common.block.multiblock.nanoBotBeacon.NanoBotBeaconStructure.STRUCTURE_DEFINITION_TIER_3;
import static ruiseki.omoshiroikamo.common.block.multiblock.nanoBotBeacon.NanoBotBeaconStructure.STRUCTURE_TIER_3;
...
public class TENanoBotBeaconT3 extends TENanoBotBeacon {

    public TENanoBotBeaconT3() {
        super(300000);
    }
    ...
    @Override
    protected IStructureDefinition<TENanoBotBeaconT3> getStructureDefinition() {
