package ruiseki.omoshiroikamo.client.render.block.voidMiner;
...
public class VoidMinerTESR extends TileEntitySpecialRenderer implements IItemRenderer {
    ...
    private static final ResourceLocation panelRes = new ResourceLocation(
        LibResources.PREFIX_BLOCK + "voidresminer_tex.png");
    private static final ResourceLocation panelOre = new ResourceLocation(
        LibResources.PREFIX_BLOCK + "voidoreminer_tex.png");
    ...
    @SideOnly(Side.CLIENT)
    private void renderBeam(TEVoidMiner miner, double x, double y, double z, float partialTicks) {
