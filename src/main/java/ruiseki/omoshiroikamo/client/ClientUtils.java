...
package ruiseki.omoshiroikamo.client;
            ...
            if (outputs != null) {
                ...
                while (itCon.hasNext()) {
                    ...
                    if (tileEnd instanceof IWireConnectable) {
                        ...
                        drawConnection(
                            con,
                            (IWireConnectable) startTileForRender,
                            (IWireConnectable) tileEnd,
